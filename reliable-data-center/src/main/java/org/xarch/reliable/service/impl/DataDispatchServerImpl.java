...
public class DataDispatchServerImpl implements DataDispatchServer {
	...
	public Map<String, Object> dispatch(String xrdataction, Map<String, Object> bodyMap, Map<String, Object> responseMap) {
		...
		case getCollectmap:
			...
			break;
		case setBillinfo:
			responseMap.put("body", dataActionServer.onSetBillinfo((String)bodyMap.get("openid"), (String)bodyMap.get("actid"), (String)bodyMap.get("reliableMoney")));
			break;
		case getBillinfo:
			responseMap.put("body", dataActionServer.onGetBillinfo((String)bodyMap.get("openid")));
			break;
		case getCheck:
			responseMap.put("body", dataActionServer.onGetCheck((String)bodyMap.get("actid")));
			break;
		case setCheck:
			responseMap.put("body", dataActionServer.onSetCheck((String)bodyMap.get("actid")));
			break;
		case fallback:
